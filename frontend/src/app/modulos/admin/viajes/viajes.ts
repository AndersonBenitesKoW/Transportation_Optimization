...
export class ViajesComponent implements OnInit {
  ...
  cargarDatos() {
    ...
    this.apiService.getVehiculos().subscribe({ next: (r) => this.vehiculos = r.data || [] });
    this.apiService.getFlota().subscribe({ next: (r) => this.flotaTelemetry = r.data || [] });
    this.apiService.getDesplazamientos().subscribe({ next: (r) => this.desplazamientos = r.data || [] });
  }
