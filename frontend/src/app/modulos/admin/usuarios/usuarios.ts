...
import { ApiService, Usuario, Conductor } from '../../../services/api.service';
...
export class UsuariosComponent implements OnInit {
  ...
  guardar() {
    ...
    if (this.modo === 'crear') {
      ...
      this.apiService.updateUsuario(this.editandoId!, data).subscribe({
        next: () => { this.cargarDatos(); this.cerrarModal(); },
  ...
  ejecutarEliminar() {
    ...
    this.cargando = true;
    this.apiService.deleteUsuario(this.eliminarId).subscribe({
