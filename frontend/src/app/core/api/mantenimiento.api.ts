...
import { AlertaMantenimiento, Componente } from '../../shared/models';

/**
 * Mantenimiento preventivo: seguimiento de desgaste de componentes y
 * generacion/resolucion de alertas.
 *
 * Las lecturas de alertas se hacen por polling contra el backend; las
 * escrituras de componentes van directas a Firestore.
 */
@Injectable({
  providedIn: 'root'
})
