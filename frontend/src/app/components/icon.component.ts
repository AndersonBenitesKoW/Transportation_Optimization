...
const ICONS: Record<string, string> = {
  ...
  'bell': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.268 21a2 2 0 0 0 3.464 0"/><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>`,
...
@Component({
  ...
  standalone: true,
  template: `<span class="icon-inner" [innerHTML]="svg"></span>`,
  styles: [`.icon-inner{display:contents}.icon-inner svg{width:100%;height:100%;display:block}`],
...
export class IconComponent {
  ...
  @Input() set img(val: string) {
    this._svg = this.sanitizer.bypassSecurityTrustHtml(ICONS[val] || '');
  }
